 ...
 * New Product in regards to sale along with Transaction's attributes.
...
public class NewProductTransaction extends Transaction {
	private int quantity;
	
	public NewProductTransaction(Item item, int quantity) {
		super(item);
	...
	public String getFormattedTransaction() {
		...
		String tag = String.format("(New Item #%s @$%.2f/ea)",
